 ...
 */var Q=a,K=Symbol.for("react.element"),X=Symbol.for("react.fragment"),Z=Object.prototype.hasOwnProperty,ee=Q.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,te={key:!0,ref:!0,__self:!0,__source:!0};function Y(e,t,l){var n,r={},s=null,i=null;l!==void 0&&(s=""+l),t.key!==void 0&&(s=""+t.key),t.ref!==void 0&&(i=t.ref);for(n in t)Z.call(t,n)&&!te.hasOwnProperty(n)&&(r[n]=t[n]);if(e&&e.defaultProps)for(n in t=e.defaultProps,t)r[n]===void 0&&(r[n]=t[n]);return{$$typeof:K,type:e,key:s,ref:i,props:r,_owner:ee.current}}T.Fragment=X;T.jsx=Y;T.jsxs=Y;V.exports=T;var o=V.exports;const j=({text:e,textColor:t="#3d3d3d",fillColor:l="#f47979",fillSpeed:n=100,fillDelay:r=30,fillDirection:s="left-right",fillType:i="scroll",fillDuration:d=2e3,freeScroll:c=!1})=>{const u=a.useRef(null),f=a.useMemo(()=>k(t),[t]),y=a.useMemo(()=>k(l),[l]),{generateClipPathFunction:m}=ie({fillType:i,ref:u,fillDelay:r,fillDirection:s,fillSpeed:n,fillDuration:d,textLength:e.length,freeScroll:c});return o.jsx("div",{ref:u,children:e.map((h,g)=>o.jsxs("div",{style:{position:"relative",width:"fit-content",whiteSpace:"nowrap"},children:[o.jsx("div",{style:f,children:h}),o.jsx("div",{style:{clipPath:m(g),position:"absolute",color:l,top:0,left:0,...y},children:h})]},h+"-"+g))})};try{j.displayName="TextReveal",j.__docgenInfo={description:"",displayName:"TextReveal",props:{text:{defaultValue:null,description:"Array of text.",name:"text",required:!0,type:{name:"string[]"}},textColor:{defaultValue:{value:"#3d3d3d"},description:`Initial color of the text before fill.
